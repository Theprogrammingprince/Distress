                ...
                <div className="lg:col-span-1">
                    <div className="bg-white rounded-2xl p-6 border border-gray-200">
                        ...
                        <div className="flex items-baseline gap-2 mb-4">
                            <span className="text-xl font-bold text-gray-900">$ 300.00</span>
                            <span className="text-sm text-gray-400 line-through">$ 400.00</span>
                        </div>
                        ...
                        <div className="flex gap-3">
                            ...
                            <button className="flex-1 px-4 py-2.5 bg-amber-500 hover:bg-amber-600 text-white rounded-lg transition-colors text-sm font-medium">
                                Create Product
                            </button>
                        </div>
                    </div>
