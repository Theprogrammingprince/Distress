...
CREATE TABLE IF NOT EXISTS notifications (
    ...
    type VARCHAR(50) NOT NULL, -- 'verification_approved', 'verification_rejected', 'verification_pending', 'product_approved', 'product_rejected', 'order_update', 'system'
    title VARCHAR(255) NOT NULL,
    message TEXT NOT NULL,
    metadata JSONB DEFAULT '{}', -- Additional data like rejection_reason, product_id, etc.
...
-- ============================================
-- FUNCTION: Create notification on seller rejection
-- ============================================
...
-- ============================================
-- FUNCTION: Reset to pending when rejected seller updates profile
-- ============================================
